...
public class AES256Util {
     ...
     * 密钥, 256位32个字节
     */
    public static final String DEFAULT_SECRET_KEY = "wtda;X0HPTt=M9_e96v&76G~+5}3;}8%";
     ...
     */
    private static final byte[] KEY_VI = "c550Gq-YQ$2QUlMc".getBytes();
    ...
    public static String encode(String key, String content) {
        try {
            ...
            // 将加密后的数据转换为字符串
            return Base64.encodeBytes(byteAES);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
